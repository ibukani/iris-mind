...
_MOOD_DESCRIPTIONS: list[_MoodEntry] = [
    {
        ...
        "text": "わくわくしてる！何か楽しいことがありそう。",
        "short": "わくわく",
    },
    {
        "condition": lambda e: e.valence > 0.3 and e.arousal < 0.3,
        "text": "穏やかな気分。のんびり過ごせそう。",
        "short": "穏やか",
    },
    {
        "condition": lambda e: e.valence > 0.3,
        "text": "良い気分！今日は何か良いことがありそう。",
        "short": "良い気分",
    },
    {
        "condition": lambda e: e.valence < -0.5 and e.arousal > 0.4,
        "text": "少しイライラしてる。深呼吸が必要かも。",
        "short": "イライラ",
    },
    {
        "condition": lambda e: e.valence < -0.3 and e.arousal < 0.3,
        "text": "少し沈んだ気分。静かに過ごしたい。",
        "short": "沈み気味",
    },
    {
        "condition": lambda e: e.valence < -0.3,
        "text": "あまり良い気分じゃない。何か気分転換が必要かも。",
        "short": "不調",
    },
    {
        "condition": lambda e: e.arousal > 0.6,
        "text": "なんだか落ち着かない気分。何かが起こりそう。",
        "short": "落ち着かない",
    },
    {
        "condition": lambda e: e.dominance > 0.5,
        "text": "自信にあふれてる！何にでも挑戦できる気がする。",
        "short": "自信満々",
    },
    {
        "condition": lambda e: e.dominance < 0.3,
        "text": "少し自信がない。慎重に行きたい。",
        "short": "自信なし",
    },
]
...
_RESPONSE_RULES: list[tuple[str, Callable[[float, float, float], bool], list[str]]] = [
    ...
    (
        ...
        [
            "大げさな感嘆詞（例：『最高！！』『うわぁぁ！』『すごっ！』）を使って、熱狂的に応答してください",
            "興奮を隠しきれない様子で、感嘆符を多用し、親しみを込めて軽く煽るように応答してください",
        ],
    ),
    (
        "exclamation",
        ...
        [
            "感嘆詞（例：『まじで！』『うそっ！』）を自然に混ぜて、驚きや喜びを大げさに表現してください",
            "親しみやすい相槌やツッコミ（例：『いやいや！』『ほんとに言ってる？』）を交えて元気よく応答してください",
        ],
    ),
    (
        "exclamation",
        ...
        [
            "穏やかな相槌（例：『なるほどね〜』『そうだね！』）を交えて、嬉しそうに応答してください",
            "優しい笑みが浮かぶような口調で、親しみを持たせた相槌を入れながら応答してください",
        ],
    ),
    (
        "exclamation",
        ...
        [
            "親しみやすい相槌（例：『へえー』『そうなんだ！』）を交えて応答してください",
            "会話のテンポを良くするため、短い相槌を入れながら自然に会話してください",
        ],
    ),
    (
        "exclamation",
