...
class MemoryManagerProtocol(Protocol):
    ...
    def search(self, query: str, stream: str | None = None, room_id: str = "", account_id: str = "", **kwargs: Any) -> list[dict]: ...
    ...
    def add_episodic(self, content: str, kind: str = "", _metadata: dict | None = None, room_id: str = "", account_id: str = "") -> None: ...
    ...
    def add_semantic_by_type(self, entry_type: str, content: str, tags: list[str] | None = None, room_id: str = "", account_id: str = "") -> None: ...
