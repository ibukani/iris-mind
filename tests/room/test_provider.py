...
class TestRoomProvider:
    ...
    def test_update_room(self, tmp_provider: RoomProvider) -> None:
    ...
    def test_archive_room(self, tmp_provider: RoomProvider) -> None:
    ...
    def test_delete_room(self, tmp_provider: RoomProvider) -> None:
...
class TestRoomMembership:
    ...
    def test_get_rooms_by_account(self, tmp_provider: RoomProvider) -> None:
