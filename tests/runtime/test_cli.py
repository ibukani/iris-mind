"""Tests for the v1.2.1 target runtime CLI entrypoint.

These tests verify:
  - CLI runs one turn with fake LLM
  - CLI produces deterministic output
  - CLI functions do not import legacy Kernel/EventBus modules
  - runtime wiring does not import legacy modules
"""
